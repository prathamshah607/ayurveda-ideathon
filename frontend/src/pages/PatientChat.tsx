...
function PatientChat() {
  ...
  return (
    <div className="doctor-chat patient-chat">
      <header className="chat-header">
        <Link to="/" className="back-button">← Back</Link>
        <div className="header-content">
          <h1>🧘 Patient Chat</h1>
          <p>Easy-to-understand Ayurvedic guidance for wellness</p>
        </div>
      </header>
      ...
      <div className="chat-container">
        <div className="messages-container">
          {messages.length === 0 && (
            <div className="welcome-message patient-welcome">
              <h2>Welcome to Patient Chat</h2>
              <p>Get personalized Ayurvedic guidance in simple, easy-to-understand terms.</p>
              <p>Ask about:</p>
              <ul>
                <li>Daily routines and lifestyle tips</li>
                <li>Diet plans and healthy recipes</li>
                <li>Home remedies for common issues</li>
                <li>Yoga and breathing exercises</li>
                <li>Understanding your body type (Prakriti)</li>
              </ul>
            </div>
          )}
